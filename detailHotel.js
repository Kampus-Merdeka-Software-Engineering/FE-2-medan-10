...
function renderDataToContent(hotel) {
    // get element content
    let content = document.getElementById("detail");
      ...
      <div class="sidebody htl">
        <div>
          <h2 class="text-uppercase"><a onclick="redirectToDetail(${hotelId})">${hotel.name}</a></h2>
        </div>
        <div>
          <h6 class="text-muted"><a onclick="redirectToDetail(${hotelId})">${hotel.location}</a></h4>
        </div>
        <div>
          <hr>
